    ...
    <div class="max-w-7xl">
        <div class="container px-5 ">
            <div class="flex  w-full mb-4 gap-4">
                <div>
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">{{ $date}}</h1>
                    <div class="relative max-w-sm">
                        <div class="absolute b-0 inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none ">
